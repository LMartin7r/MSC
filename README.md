...
Supplementary Table S1 (Supplementary_Table_1.xlsx) contains the complete list of candidate DMRs identified by the RoAM computational pipeline. The table includes all rows and columns.
